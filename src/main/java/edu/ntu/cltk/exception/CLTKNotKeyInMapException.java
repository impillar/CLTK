...
public class CLTKNotKeyInMapException extends Exception {

    /**
     *
     */
    private static final long serialVersionUID = 1087565421997084797L;

    public CLTKNotKeyInMapException(String string) {
        super(string);
    }
