...
public class ManifestWriter {
    ...
    public ManifestWriter(final String filePath) throws FileNotFoundException {
        this.manifestFile = filePath;
        this.ma = new ManifestApplication();
        this.os = new FileOutputStream(manifestFile);
    }

    public ManifestWriter(final FileOutputStream os) {
        this.os = os;
        this.ma = new ManifestApplication();
    }
