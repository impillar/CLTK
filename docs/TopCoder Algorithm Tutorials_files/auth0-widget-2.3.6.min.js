(function e(t, n, r) {
    ...
    4: [function (require, module, exports) {
        module.exports = {
            ...
            signin: {
                ...
                returnUserLabel: "La ultima vez inici\xf3 sesi\xf3n con...",
            ...
            signup: {
                ...
                footerText: 'Al presionar "Sign Up", usted acepta la pol\xedtica de privacidad y los terminos y condiciones.',
    ...
    5: [function (require, module, exports) {
        module.exports = {
            ...
            signin: {
                ...
                strategyDomainInvalid: "Le domaine {domain} n'a pas \xe9t\xe9 le programme d'installation.",
                ...
                returnUserLabel: "La derni\xe8re fois vous connect\xe9 \xe0 l'aide...",
                wrongEmailPasswordErrorText: "Faux email ou mot de passe.",
                or: "... ou connectez-vous \xe0 l'aide"
            },
            signup: {
                ...
                footerText: "En cliquant sur \xab S'inscrire \xbb, vous acceptez nos conditions de service et politique de confidentialit\xe9.",
                enterpriseEmailWarningText: "Ce domaine {domain} a \xe9t\xe9 configur\xe9 pour le Single Sign On et vous ne pouvez pas cr\xe9er un compte. Essayez de vous connecter \xe0 la place.",
                serverErrorText: "Il y avait une erreur de traitement le signe vers le haut."
            },
            reset: {
                title: "R\xe9initialiser mot de passe",
                action: "Envoyer",
                emailPlaceholder: "Email",
                passwordPlaceholder: "Nouveau mot de passe",
                repeatPasswordPlaceholder: "Confirmer le nouveau mot de passe",
                cancelAction: "Annuler",
                successText: "Nous avons juste envoy\xe9 un mail pour r\xe9initialiser votre mot de passe.",
                ...
                serverErrorText: "Il y avait une erreur de traitement de r\xe9initialiser le mot de passe."
            }
        }
    }, {}],
    ...
    11: [function (require, module, exports) {
        module.exports = {
            ...
            signup: {
                ...
                footerText: 'Clicando em "Sign Up", voc\xea concorda com nossos termos de servi\xe7o e pol\xedtica de privacidade.',
    ...
    12: [function (require, module, exports) {
        module.exports = {
            ...
            signup: {
                ...
                footerText: "\u041d\u0430\u0436\u0430\u0432 \xab\u0417\u0430\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u043e\u0432\u0430\u0442\u044c\u0441\u044f\xbb, \u0432\u044b \u0441\u043e\u0433\u043b\u0430\u0448\u0430\u0435\u0442\u0435\u0441\u044c \u043d\u0430 \u043d\u0430\u0448\u0438 \u0443\u0441\u043b\u043e\u0432\u0438\u044f \u043e\u0431\u0441\u043b\u0443\u0436\u0438\u0432\u0430\u043d\u0438\u044f \u0438 \u043f\u043e\u043b\u0438\u0442\u0438\u043a\u0430 \u043a\u043e\u043d\u0444\u0438\u0434\u0435\u043d\u0446\u0438\u0430\u043b\u044c\u043d\u043e\u0441\u0442\u0438.",
    ...
    19: [function (require, module, exports) {
        ...
        Auth0.prototype._getMode = function () {
            return {scope: "openid profile", response_type: this._callbackOnLocationHash ? "token" : "code"}
        };
        ...
        Auth0.prototype.login = function (options, callback) {
            ...
            var query = xtend(this._getMode(), options, {client_id: this._clientID, redirect_uri: this._callbackURL});
        ...
        Auth0.prototype.loginWithUsernamePassword = function (options, callback) {
            ...
            reqwest({
                ...
                if (!er.status || er.status === 0) {
                    er = {};
                    er.status = 401;
                    er.responseText = {code: "invalid_user_password"}
                }
            ...
            function handleReadyState(r, success, error) {
                return function () {
                    ...
                    if (r.request && r.request[readyState] == 4) {
                        ...
                        if (twoHundo.test(r.request.status))success(r.request); else error(r.request)
                    }
                }
            }
    ...
    36: [function (require, module, exports) {
        ...
        EventEmitter.prototype.addListener = function (type, listener) {
            ...
            if (!this._events[type])this._events[type] = listener; else if (util.isObject(this._events[type]))this._events[type].push(listener); else this._events[type] = [this._events[type], listener];
    ...
    43: [function (require, module, exports) {
        ...
        if (typeof global.window.define == "function" && global.window.define.amd) {
            global.window.define("auth0-widget", function () {
                return Auth0Widget
            })
                    ...
                    (function () {
                        buf.push('<div id="a0-widget" class="a0-widget" dir="auto">\n    <div class="a0-signin ', escape((__stack.lineno = 2, locals && locals.embedded ? "a0-embedded" : "")), " ", escape((__stack.lineno = 2, options.theme ? "a0-theme-" + options.theme : "")), '">\n        <div class="a0-popup">\n            <div class="a0-overlay">\n                <div class="a0-centrix">\n                    ' + function () {
                                ...
                                buf.push("\n    </div>\n\n\n    " + function () {
                                        ...
                                        var buf = [];
                                        buf.push('<div class="a0-signup a0-mode" style="display: none;">\n    <form>\n        <div class="a0-collapse-social-signup">\n          <div class="a0-iconlist" style="display: none"><p style="display:none">', escape((__stack.lineno = 4, i18n.t("signin:or"))), '</p></div>\n          <div class="a0-separator" style="display: none"><span>', escape((__stack.lineno = 5, i18n.t("signin:separatorText"))), '</span></div>\n        </div>\n        <div class="a0-header">', escape((__stack.lineno = 7, i18n.t("signup:headerText"))), '</div>\n        <div class="a0-emailPassword">\n            <div class="a0-email">\n                <label for="a0-signup_easy_email" class="a0-sad-placeholder">\n                  ', escape((__stack.lineno = 11, i18n.t("signup:emailPlaceholder"))), '\n                </label>\n                <input name="email" id="a0-signup_easy_email"\n                       type="email" value="" required\n                       placeholder="', escape((__stack.lineno = 15, i18n.t("signup:emailPlaceholder"))), '"\n                       title="', escape((__stack.lineno = 16, i18n.t("signup:emailPlaceholder"))), '">\n            </div>\n            <div class="a0-password">\n                <label for="a0-signup_easy_password" class="a0-sad-placeholder">\n                  ', escape((__stack.lineno = 20, i18n.t("signup:passwordPlaceholder"))), '\n                </label>\n                <input name="password" id="a0-signup_easy_password"\n                       type="password" value="" required\n                       placeholder="', escape((__stack.lineno = 24, i18n.t("signup:passwordPlaceholder"))), '"\n                       title="', escape((__stack.lineno = 25, i18n.t("signup:passwordPlaceholder"))), '">\n            </div>\n            <div class="a0-action">\n                <button type="submit" class="a0-zocial a0-primary a0-next" style="width: 100%;">', escape((__stack.lineno = 28, i18n.t("signup:action"))), '</button>\n                <div class="a0-options">\n                    <a href="javascript: {}" class="a0-centered a0-cancel">', escape((__stack.lineno = 30, i18n.t("signup:cancelAction"))), "</a>\n                </div>\n            </div>\n        </div>\n    </form>\n</div>");
                                        return buf.join("")
                                    }() + "\n    " + function () {
                                        var buf = [];
    ...
    49: [function (require, module, exports) {
        ...
        Auth0Widget.prototype._isEnterpriseConnection = function (email, output) {
            ...
            var conn = _.chain(this._client.strategies).where({userAndPass: undefined}).pluck("connections").flatten().findWhere({domain: email_domain}).value();
            if (conn && output) {
        ...
        Auth0Widget.prototype._getAuth0Connection = function () {
            if (this._signinOptions["userPwdConnectionName"]) {
                return _.chain(this._auth0Strategies).pluck("connections").flatten().findWhere({name: this._signinOptions["userPwdConnectionName"]}).value()
            }
        ...
        Auth0Widget.prototype._signInEnterprise = function (e) {
            ...
            var conn_obj = _.chain(this._client.strategies).where({userAndPass: undefined}).pluck("connections").flatten().findWhere({domain: input_email_domain}).value();
            if (conn_obj) {
        ...
        Auth0Widget.prototype._resolveLoginView = function () {
            ...
            _.chain(self._client.strategies).where({social: true}).map(function (s) {
                return _.extend({}, s, {use_big_buttons: use_big_buttons})
            }).each(function (s) {
        ...
        Auth0Widget.prototype._show = function (signinOptions, callback) {
            ...
            self._signinOptions.extraParameters = utils.extract(self._signinOptions, ["state", "access_token", "scope", "protocol", "request_id"]);
            if (self._signinOptions.container) {
        ...
        "../lib/insert-css": 15,
        "./html/button.ejs": 44,
        "./html/loggedin_button.ejs": 45,
        "./html/login_actions.ejs": 46,
        "./html/main.ejs": 47,
        "./html/main_embedded.ejs": 48,
        "./js/bonzo_qwery": 50,
        "./js/collapse_onfocus": 51,
        "./js/is_small_screen": 52,
        "./js/strategies": 53,
        "./modes/reset": 54,
        "./modes/signup": 55,
        "./pf/Object.create": 56,
        "./pf/has_animations": 57,
        "./pf/placeholderSupported": 58,
        "./pf/transition_end": 59,
        "./pf/utils": 60,
        "auth0-js": 19,
        events: 36,
        "has-transitions": 40,
    ...
    }, {bean: 33, bonzo: 34, domready: 39, qwery: 41}],
    ...
    53: [function (require, module, exports) {
        module.exports = {
            "google-openid": {css: "google", title: "Google OpenId", social: true},
            "google-apps": {css: "google", title: "Google Apps", social: false},
            "google-oauth2": {css: "googleplus", title: "Google", social: true},
            facebook: {css: "facebook", title: "Facebook", social: true},
            windowslive: {css: "windows", title: "Microsoft Account", social: true},
            linkedin: {css: "linkedin", title: "LinkedIn", social: true},
            github: {css: "github", title: "GitHub", social: true},
            paypal: {css: "paypal", title: "PayPal", social: true},
            twitter: {css: "twitter", title: "Twitter", social: true},
            amazon: {css: "amazon", title: "Amazon", social: true},
            vkontakte: {css: "vk", title: "vKontakte", social: true},
            yandex: {css: "yandex", title: "Yandex", social: true},
            office365: {css: "office365", title: "Office365", social: false},
            waad: {css: "waad", title: "Windows Azure AD", social: false},
            adfs: {css: "windows", title: "ADFS", social: false},
            samlp: {css: "guest", title: "SAML", social: false},
            mscrm: {css: "guest", title: "Dynamics CRM", social: false},
            ad: {css: "windows", title: "AD / LDAP", social: false, userAndPass: true},
            custom: {css: "guest", title: "Custom Auth", social: false},
            auth0: {css: "guest", title: "Auth0", social: false, userAndPass: true},
            "auth0-adldap": {css: "guest", title: "AD/LDAP", social: false, userAndPass: true},
            thirtysevensignals: {css: "thirtysevensignals", title: "37 Signals", social: true},
            box: {css: "box", title: "Box", social: true, imageicon: true},
            salesforce: {css: "salesforce", title: "Salesforce", social: true},
            fitbit: {css: "fitbit", title: "Fitbit", social: true}
        }
    }, {}],
    ...
    }, {"../js/bonzo_qwery": 50, "../js/collapse_onfocus": 51, "../js/is_small_screen": 52}],
    55: [function (require, module, exports) {
        ...
        signup.bind = function (widget) {
            ...
            _.chain(widget._client.strategies).where({social: true}).map(function (s) {
                return _.extend({}, s, {use_big_buttons: false})
            }).each(function (s) {
                return list.append(buttonTmpl(s))
            });
    ...
    60: [function (require, module, exports) {
        ...
        module.exports = {
            parseUrl: function (url) {
                ...
                return _.pairs(pre).filter(function (pair) {
